...
public class UserList extends AppCompatActivity {
    ...
    public String[] locations = {"Great Court","UQ Lakes","Main Refectory","Chancellor's Place","GP South"};
    public String[] categories = {"Relaxing","Nice Views","Food and Drink","Artistic","Technology","Library","Quiet","Noisy","Crowded","Science"};
                    ...
                    if(jsonObject.length() > 0) {
                        ...
                        if(lenArray > 0) {
                            for( ; jIndex < lenArray; jIndex++) {
                                ...
                                String name_i = innerObject.getString(Keys.KEY_NAME);
                                String country_i = innerObject.getString(Keys.KEY_COUNTRY);
//                                String image = innerObject.getString(Keys.KEY_IMAGE);
                                ...
                                /*Process reading of data to transpose numbers back to string*/
                                String name = categories[Integer.parseInt(name_i)];
                                String country = locations[Integer.parseInt(country_i)];
